 ...
 * @author vendetta
 */
public class PemasukanViewFrame extends javax.swing.JFrame {

    /**
     * Creates new form PemasukanViewFrame
     */
    public PemasukanViewFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cari Pemasukan");
        ...
        viewTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Sumber Dana", "Nominal Pemasukan", "Tanggal Pemasukan", "Keterangan"
            }
        ) {
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariButtonActionPerformed
        try {
            ...
            String selectSQL = "SELECT * FROM tb_pemasukan WHERE asal_pemasukan like '%"+kataKunci+"%' ";
            ...
            while(resultSet.next()){
                row[0] = resultSet.getInt("id_pemasukan");
                row[1] = resultSet.getString("asal_pemasukan");
                row[2] = resultSet.getString("nominal_pemasukan");
                row[3] = resultSet.getString("tanggal_pemasukan");
                row[4] = resultSet.getString("keterangan_pemasukan");
                model.addRow(row);
            }
            koneksi.close();
    ...
    private void tambahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahButtonActionPerformed
        PemasukanAddFrame f = new PemasukanAddFrame();
        f.setVisible(true);
    ...
    private void ubahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubahButtonActionPerformed
        ...
        if(barisTerpilih >= 0){
            ...
            PemasukanAddFrame f = new PemasukanAddFrame(id);
            f.setVisible(true);
        }else{
        ...
        if(barisTerpilih >= 0){
            ...
            if(pilihan == 0){
                try {
                    ...
                    int id = (int) model.getValueAt(barisTerpilih, 0);
                    Connection koneksi = Basisdata.getConnection();
                    String deleteSQL = "DELETE FROM tb_pemasukan WHERE id_pemasukan="+id;
                    Statement statement = koneksi.createStatement();
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try {
            Connection koneksi = Basisdata.getConnection();
            String selectSQL = "SELECT * FROM tb_pemasukan";
            Statement statement = koneksi.createStatement();
            ResultSet resultSet = statement.executeQuery(selectSQL);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PemasukanViewFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PemasukanViewFrame().setVisible(true);
            }
        });
    }
